...
describe('translation scope discovery', () => {
  ...
  it.each([
    ...
    'apps/desktop/dist/mac-arm64/DeepSeek Desktop.app/Contents/Resources/npm/README.md',
    'apps/desktop/runtime-npm/npm/README.md',
    'output/astra-final-20260911/original-candidate.app/Contents/Resources/npm/README.md',
